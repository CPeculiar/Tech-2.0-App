  ...
  return (
    <div className='flex flex-col p-5 rounded-lg h-full w-full gap-2'>
        ...
        <div key={item.group_name} onClick={() => handleShowInfo(item)} className='account_details w-full flex flex-col bg-[#2D2A32]/50 p-5 rounded-lg gap-4'>
            ...
            {selectedItem && selectedItem.group_name === item.group_name && (
                <div className="moreinfo absolute bg-[#2D2A32]/50 p-5 rounded-lg overflow-y-scroll h-fit w-[500px] top-[-30px] left-[50%] backdrop-blur-lg">
                    <p className='flex justify-between mb-3'>
                    {selectedItem.group_name}
                    <FontAwesomeIcon icon={faCircleXmark} size='lg' onClick={() => handleShowInfo(null)} />
                    </p>
