    ...
    <div className='sidebar relative p-3 bg-[#121212]/30 rounded-lg w-fit flex flex-col gap-10'> 
      ...
      >
        ...
        <motion.li onClick={handleIsTransfer} className='nav-item' whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.998}}>
          ...
          <motion.li onClick={handleLogout} className='nav-item hover:bg-red-700 ease-in duration-150' whileHover={{ scale: 1.02 }} whileTap={{ scale:0.998 }}>
            Logout
          </motion.li>
        </ul>
      </motion.nav>
      <div className='absolute bottom-5 flex flex-col items-start'>
      <button onClick={toggleSidebar}><FontAwesomeIcon icon={faCircle} className='text-white '/></button>
